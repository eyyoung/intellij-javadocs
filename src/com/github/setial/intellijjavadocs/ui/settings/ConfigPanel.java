...
public class ConfigPanel extends JPanel {
    ...
    public boolean isModified() {
        ...
        result = result || !editorAuthor.getText().equals(settings.getGeneralSettings().getAuthName());
        result = result || !editorDate.getText().equals(settings.getGeneralSettings().getDateFormat());
    ...
    public void apply() {
        ...
        settings.getGeneralSettings().setAuthName(editorAuthor.getText());
        settings.getGeneralSettings().setDateFormat(editorDate.getText());
    ...
    public void reset() {
        ...
        editorDate.setText(settings.getGeneralSettings().getDateFormat());
        editorAuthor.setText(settings.getGeneralSettings().getAuthName());
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        generalPanel.setLayout(new GridLayoutManager(4, 3, new Insets(10, 10, 10, 10), -1, -1));
        ...
        generalOtherPanel.setLayout(new GridLayoutManager(6, 1, new Insets(0, 0, 0, 0), -1, -1));
        ...
        editorAuthor = new JEditorPane();
        editorAuthor.setOpaque(true);
        editorAuthor.setToolTipText("Author");
        generalOtherPanel.add(editorAuthor, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        editorDate = new JEditorPane();
        generalOtherPanel.add(editorDate, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        final JLabel label1 = new JLabel();
        label1.setText("作者(author)");
        generalOtherPanel.add(label1, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label2 = new JLabel();
        label2.setText("时间(date)");
        generalOtherPanel.add(label2, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
