...
public class JavaDocSettings implements Serializable {
    ...
    public JavaDocSettings(Element element) {
        ...
        if (general != null) {
            ...
            generalSettings.setAuthName(XmlUtils.getValue(general,AUTHNAME));
            generalSettings.setDateFormat(XmlUtils.getValue(general,DATEFORMAT));
        }
    ...
    public void addToDom(Element root) {
        ...
        general.addContent(XmlUtils.getElement(AUTHNAME,generalSettings.getAuthName()));
        general.addContent(XmlUtils.getElement(DATEFORMAT,generalSettings.getDateFormat()));
